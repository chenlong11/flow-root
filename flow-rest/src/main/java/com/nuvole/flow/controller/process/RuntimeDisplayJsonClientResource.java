...
public class RuntimeDisplayJsonClientResource {
    ...
    @RequestMapping(value = "/process-instances/debugger/{processInstanceId}/model-json", method = RequestMethod.GET, produces = "application/json")
    ...
    @RequestMapping(value = "/process-instances/{processInstanceId}/model-json", method = RequestMethod.GET, produces = "application/json")
